        ...
        try
         {
            ...
            String Query="SELECT MOBILENO,ACCOUNTNO,PIN FROM PREETHI.ACCOUNTS WHERE MOBILENO=?";
            java.sql.PreparedStatement pstmt=con.prepareStatement(Query);
            pstmt.setString(1,jTextField1.getText());
            java.sql.ResultSet rs= pstmt.executeQuery();
            if(rs.next())
            {
                String Query1="DELETE FROM PREETHI.RECORD";
                java.sql.Statement ps=con.createStatement();
                ps.executeUpdate(Query1);
                String Query2="INSERT INTO PREETHI.RECORD VALUES(?,?,?)";
                ...
                ps1.executeUpdate();
                String Query4="DELETE FROM PREETHI.OTP";
                ...
                String Query3="INSERT INTO PREETHI.OTP(MOBILENO,OTP) VALUES(?,?)";
